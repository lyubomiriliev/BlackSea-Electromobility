                        ...
                        <div className="mt-6">
                            <div>
                                <form className="flex flex-col" onSubmit={(e) => {
                                    ...
                                    <button type="submit" className="bg-primary text-white text-base py-3 px-8 tracking-wide rounded-md self-center w-60 hover:bg-secondary duration-300">Вход</button>
                                </form>
